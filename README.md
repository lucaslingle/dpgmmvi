...
The second version is currently the only one iremplemented in `dpgmmvi/algos.py`, which was rewritten from the legacy implementations to support streamlit visualizations. In general, I recommend using the `dpgmmvi/algos.py` version.
