...
The second version is currently implemented in `dpgmmvi/algos.py` as well. It was rewritten from the legacy implementations, and also supports streamlit visualizations. In general, I recommend using the `dpgmmvi/algos.py` version.
